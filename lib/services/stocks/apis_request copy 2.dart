...
//             var brokarageFund = brokarageFunds[innovaFundName] ??
//                 brokarageFunds[innovaShortName];

//             if (brokarageFund != null) {
//               final double rawUnits =
//                   double.parse(innovaFund["Units"]?.toString() ?? "0");
//               final double units =
//                   double.parse((rawUnits / 100).toStringAsFixed(4));
//               final double unitPrice =
//                   double.parse(brokarageFund["nav"]?.toString() ?? "0");
//               final double fundInvestedValue =
//                   double.parse("${innovaFund["Contributions"]}") -
//                       double.parse("${innovaFund["Withdrawals"]}");

//               final double fundCurrentValue = units * unitPrice;
//               final double fundGainLoss = fundCurrentValue - fundInvestedValue;
...
//                 profitLossPercentage: (fundInvestedValue != 0)
//                     ? (fundGainLoss / fundInvestedValue * 100)
//                         .toStringAsFixed(2)
//                     : "0",
...
//   Future<Map<String, dynamic>> getMyPortfolio({
//     required MarketProvider mp,
//     required BuildContext context,
//   }) async {
//     try {
...
//         'profitLoss': data['profitLoss'] ?? 0.0,
//         'profitLossPercentage': data['percentageChange'] ?? 0.0,
//       };
//     } catch (e) {
//       print('====== getMyPortfolio ${e}');
//       // ErrorHandler.showError(
...
//   Future<Map<String, dynamic>> getMyFundPortfolio({
//     required MarketProvider mp,
//     required BuildContext context,
//   }) async {
//     try {
...
//       if (response['success']) {
//         var data = response['data']['data'];
//         print('====== getMyFundPortfolio ${response['data']}');
...
//         // );
//         return {
//           'investedValue': data['investedValue'] ?? 11230.0,
//           'currentValue': data['currentValue'] ?? 0.0,
//           'profitLoss': data['profitLoss'] ?? 0.0,
//           'profitLossPercentage': data['percentageChange'] ?? 0.0,
//         };
